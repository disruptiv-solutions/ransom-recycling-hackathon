  ...
  return (
    <div className="relative min-h-screen bg-linear-to-br from-white via-[#4d8227] to-[#3a91ba] overflow-hidden flex flex-col items-center justify-center font-sans">
      ...
      <div className="w-full px-12 text-center relative z-10">
        {/* Top Pills */}
        <div className="flex items-center justify-center gap-6 mb-20 animate-in fade-in slide-in-from-top-4 duration-1000">
          <span className="text-sm font-black uppercase tracking-[0.5em] text-white/60">Secure</span>
          <span className="w-1 h-1 rounded-full bg-white/40" />
          <span className="text-sm font-black uppercase tracking-[0.5em] text-white/60">Scalable</span>
          <span className="w-1 h-1 rounded-full bg-white/40" />
          <span className="text-sm font-black uppercase tracking-[0.5em] text-white/60">Fundable</span>
        </div>

        {/* The Quote */}
        <div className="relative animate-in fade-in zoom-in-95 duration-1000 delay-300 mb-16">
        ...
        {/* Divider Line */}
        <div className="mx-auto w-32 h-0.5 bg-white/30 rounded-full mb-16 animate-in fade-in duration-1000 delay-700" />

        {/* Subtext */}
        <p className="text-xl lg:text-2xl text-white/80 font-medium max-w-3xl mx-auto mb-20 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-1000">
          This is the shift from simple tracking to <span className="text-white font-bold">true operations intelligence.</span>
        </p>

        {/* CTA Section */}
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-1200">
